...
public class JwtProvider {
    ...
    public static String serializeRoles(User user) {
        ...
        user.getPermissions().forEach(item -> {
            scope.append("PERMISSION_" + item.getPermission().getPermissionName()).append(" ");
            // permission
        });

        user.getPermissions().forEach(item -> {
            scope.append("BANNED_" + item.getPermission().getPermissionName()).append(" ");
            // permission
        });
