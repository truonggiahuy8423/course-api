package com.example.course.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<AppResponse<Object>> handlingRuntimeException(Exception exception) {
        ...
        return new ResponseEntity<AppResponse<Object>>(
                new AppResponse<>(HttpStatus.BAD_REQUEST.value(), ApiMessage.FAILED,
                        new ErrorResponse(errorType.getErrorCode(),
                                errorType.getErrorMessage() + " - " + exception.getMessage())),
    ...
    ResponseEntity<AppResponse<Object>> handlingValidationException(AppRuntimeException exception) {
        ...
        return new ResponseEntity<AppResponse<Object>>(
                new AppResponse<>(exception.getHttpStatus().value(), ApiMessage.FAILED,
    ...
    // public ResponseEntity<AppResponse<Object>>
    ...
    // ApiMessage.FAILED,
    // new ErrorResponse(errorType.getErrorCode(), exception.getMessage())),
    ...
    // Handler cho ObjectOptimisticLockingFailureException (xung đột do xử lý
    // locking optimistic)
    @ExceptionHandler(value = ObjectOptimisticLockingFailureException.class)
    public ResponseEntity<AppResponse<Object>> handleOptimisticLockingFailureException(
